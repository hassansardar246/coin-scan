...
const NewListingRecords = ({ coins, refetch }) => {
  console.log(coins);
        ...
        >
          ...
          <td className="text-text-light min-w-40">
            <IconText
              ...
              text={item?.chain_abbreviation || "No"}
            />
          </td>
          <td className="text-text-light min-w-40">
            {item?.price_change_24h == 0 ? (
              ...
              <ColoredNumber number={parseInt(item?.price_change_24h) || 0} />
            )}
          </td>
          <td className="text-text-light min-w-40">
  ...
  return (
    <div className="my-10  relative">
      ...
      <Table
        header={
          <div className="m-5">
            <Text className="text-text-primary text-2xl md:text-3xl font-bold">
              New Listing
            </Text>
          </div>
        }
...
export default NewListingRecords;
